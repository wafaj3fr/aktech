        ...
        <section class="saf_pricing_wrapper" id="Vision">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="saf_about_detail wow fadeInRight" data-wow-duration="1s" style="text-align: left;">
                    <?php
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="saf_about_img relative wow fadeInUp" data-wow-duration="1s">
                           ...
                           <button onclick="myFunction2()" id="myBtn2" class="saf_btn" style="float: right;right: 70px;">Read more</button>
                            </div>
                        </div>
                    </div>
                </div>
