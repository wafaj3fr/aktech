            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  $U_info = $_GET['id_AboutUSEdite'];
                  $sql_content = "SELECT name,detiles FROM content WHERE idcontent ='$U_info'";
                  $resultcontent = mysqli_query($conn, $sql_content);
                  $rowcontent = mysqli_fetch_assoc($resultcontent);
                  ?>
                  <?php echo "<b>".$rowcontent["name"]."</b>";?>
                <textarea  name="NewDetiles" id="NewDetiles" class="form-control" rows="8" 
                placeholder="" value=""><?php echo $rowcontent["detiles"];?></textarea>
              ...
              <input type="submit"  name="editaboutus" id="editaboutus" value="EDIT" class="btn btn-primary">
              ...
              $New_Det = $_POST['NewDetiles'];
              // idExperience	UserExperience	PlaceExperience	JopExperience	StartExperience	EndExperience	
              $sql_update_det = "UPDATE content SET detiles='$New_Det' WHERE idcontent=".$U_info;
              if ($conn->query($sql_update_det) == TRUE) {
