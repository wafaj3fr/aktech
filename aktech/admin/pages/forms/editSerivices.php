        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php
        //   echo $_SESSION["user_login"].$_GET['id_ServicesEdit'];
          $U_info = $_GET['id_ServicesEdit'];
        // servicesid	servicesName	servicesIcon	servicesStutas   
          $sql_services = "SELECT * FROM services WHERE servicesid ='$U_info'";
          ...
          ?>
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Servtitle" id="Servtitle" placeholder="Title" value='<?php echo $rowservices["servicesName"];?>'>
                  </div>
                  <img src="<?php echo $rowservices["servicesIcon"]?>" alt="" width="150" height="150" >
                 <br>
                  <label for="exampleInputEmail1">Services Icpn</label>
                  <input type="file" class="form-control" name="fileToUpload" id="fileToUpload">
                <br>
                <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label>Services Stutas Select</label>
                        <select class="form-control"  id="Servtype" name="Servtype">
                        <option value="Shwo">Shwo</option>
                ...
                <div class="card-footer">
                 <input type="submit"  name="addServices" id="addServices" value="SAVE" class="btn btn-primary">
              ...
              if(isset($_POST['addServices']))
              {
                      ...
                      if($uploadOk == 1)
                      {
                          $Stitle = $_POST['Servtitle'];
                          $SfileToUpload = isset($_POST['fileToUpload']);
                          $Stype = $_POST['Servtype'];
                        //   $st = "Open";

                        // servicesid	servicesName	servicesIcon	servicesStutas   
                        $sql_update_services = "UPDATE services SET servicesName='$Stitle',servicesIcon='$target_file',servicesStutas='$Stype'
                         WHERE servicesid=".$U_info;
                        if ($conn->query($sql_update_services) == TRUE) {
