              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Clienttitle" id="Clienttitle" placeholder="Title">
                  </div>
                ...
                <div class="card-footer">
                 <input type="submit"  name="addClient" id="addClient" value="SAVE" class="btn btn-primary">
              ...
              if(isset($_POST['addClient']))
              {
                      ...
                      if($uploadOk == 1)
                      {
                        ...
                        // clientid	clientsName	clientsIcon	 clientsStutas
                        	$queryopp="INSERT INTO clients (clientsName,clientsIcon,clientsStutas) VALUES ('".$Ctitle."','".$target_file."','".$CStutas."')";     
