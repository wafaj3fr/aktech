              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  <!-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="testtitle" id="testtitle" placeholder="Title">
                  </div> -->
                  
                  <div class="form-group">
                    <label for="exampleInputEmail1">Testimonial Name</label>
                    <input type="text" class="form-control" name="testname" id="testname" placeholder="Title">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Testimonial Job Title</label>
                    <input type="text" class="form-control" name="testpostion" id="testpostion" placeholder="Title">
                  </div>
                  <!-- <div class="form-group">
                    <label for="exampleInputEmail1">Testimonial Title</label>
                ...
                <textarea  name="testcontent" id="testcontent" class="form-control" rows="3" placeholder="Content Testimonial"></textarea>
                </div>  
                <!-- <div class="form-group">
                ...
                <div class="card-footer">
                 <input type="submit"  name="addTestimonialNew" id="addTestimonialNew" value="Add" class="btn btn-primary">

                  <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
                </div>
              </form>
              <?php
              if(isset($_POST['addTestimonialNew']))
              {
                        ...
                        // if (isset($_POST["interest"] ) && $_POST["resume"] &&  $_POST["color"] && $_POST["size"] && $_POST['quantity'] != "") {
                          ...
                          $queryopp="INSERT INTO testimonial (Testimonialname,Testimoniatestpostion,Testimonialcontent)
                           VALUES ('".$test_name."','".$test_postion."','".$test_content."')";     
