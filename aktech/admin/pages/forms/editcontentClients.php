  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>PARTNERS & CLIENTS Managment</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">PARTNERS & CLIENTS</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add New PARTNERS & CLIENTS</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php
          echo $_SESSION["user_login"].$_GET['id_ClientEdit'];
          $U_info = $_GET['id_ClientEdit'];
          // clientid	clientsName	clientsIcon	 clientsStutas
          $sql_clients = "SELECT * FROM clients WHERE clientid ='$U_info'";
          ...
          ?>
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  <div class="form-group">
                    <label for="exampleInputEmail1">PARTNERS or CLIENTS Title</label>
                    <input type="text" class="form-control" name="Clienttitle" id="Clienttitle" placeholder="" value='<?php echo $rowclients["clientsName"];?>'>
                  </div>
                  <img src="<?php echo $rowclients["clientsIcon"]?>" alt="" width="150" height="150" >
                  <br>
                ...
                <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        <label> PARTNERS or CLIENTS Stutas Select</label>
                        <select class="form-control" id="ClientStutas" name="ClientStutas">
                ...
                <div class="card-footer">
                 <input type="submit"  name="EditClient" id="EditClient" value="SAVE" class="btn btn-primary">
              ...
              if(isset($_POST['EditClient']))
              {
                      ...
                      if($uploadOk == 1)
                      {
                          $Ctitle = $_POST['Clienttitle'];
                          $SfileToUpload = isset($_POST['fileToUpload']);
                          $CStutas = $_POST['ClientStutas'];
                        //   $st = "Open";


                        // clientid	clientsName	clientsIcon	 clientsStutas
                        $sql_update_client = "UPDATE  clients SET clientsName='$Ctitle',clientsIcon='$target_file',clientsStutas='$CStutas' 
                        WHERE clientid=".$U_info;
