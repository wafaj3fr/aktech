              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Servtitle" id="Servtitle" placeholder="Title">
                  </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                  <label for="exampleInputEmail1">Services Sort</label>
                    <input type="number" class="form-control" name="sersort" id="sersort" placeholder="Services Sort Number">
                    <?php
                        $q=0;
                          ...
                          $result = mysqli_query($conn, $sql);
                                            ...
                                            echo "Last Services "."<b><i>"."NO . ". $q."</i></b>";
                          ?>
                      </div>
                    </div>
                  </div>                 
              ...
              if(isset($_POST['addServices']))
              {
                      ...
                      if($uploadOk == 1)
                      {
                        ...
                        // servicesid	servicesName	servicesIcon	servicesStutas   
                            $queryopp="INSERT INTO services (servicesName,servicesIcon,servicesStutas,SerSort)
                             VALUES 
                            ('".$Stitle."','".$target_file."','".$Stype."','".$Ssort."')";     
