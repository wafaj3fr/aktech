            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  $sql_area = "SELECT * FROM news WHERE id ='$U_info'";
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="newstitle" id="newstitle" placeholder="Title" value=" <?php echo $rowarea["newstitle"];?>">
                  </div>
                  <div class="form-group">
                  <label for="exampleInputEmail1">Content Section 1 </label>
                <textarea  name="newscont1" id="newscont1" class="form-control" rows="8" 
              ...
              <input type="submit"  name="editarea" id="editarea" value="EDIT" class="btn btn-primary">
              ...
              if(isset($_POST['editarea'])){
                ...
                $new_stitle = $_POST['newstitle'];
                $new_scont1 = $_POST['newscont1'];
                $new_scont2 = $_POST['newscont2'];
                    // AREASid	areaname	areacontent	 areauser	
                    $sql_update_Area = "UPDATE  news SET newstitle='$new_stitle',newscontent1='$new_scont1',newscontent2='$new_scont2' WHERE id=".$U_info;
                if ($conn->query($sql_update_Area) == TRUE) {
                  // echo "Record updated successfully";
                  echo "<script type= 'text/javascript'>alert('updated successfully');</script>";
  
                  echo '<script>window.location.href = "../tables/newsreports.php";</script>';
