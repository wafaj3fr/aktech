            ...
            <div class="card card-primary">
              ...
              <form role="form" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                  ...
                  $sql_area = "SELECT * FROM areas WHERE AREASid ='$U_info'";
                  $resultarea = mysqli_query($conn, $sql_area);
                  $rowarea = mysqli_fetch_assoc($resultarea);
                  ?>
                  <?php echo "<b>".$rowarea["areaname"]."</b>";?>
                <textarea  name="area" id="area" class="form-control" rows="8" 
                placeholder="" value=""><?php echo $rowarea["areacontent"];?></textarea>
              ...
              if(isset($_POST['editarea'])){
                ...
                $New_Area = $_POST['area'];
                    // AREASid	areaname	areacontent	 areauser	
                    $sql_update_Area = "UPDATE  areas SET areacontent='$New_Area' WHERE AREASid=".$U_info;
