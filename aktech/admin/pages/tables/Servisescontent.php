              ...
              <table id="example5" class="table table-bordered table-striped">
                ...
                <?php
                        ...
                        // echo "<td>"."<a href =\"alluseroppor.php?id_alluserOpp=".$rowOppor['detiles']."\">".$rowOppor["detiles"]."</a>"."</td>";
                            ...
                            if($rowservices["servicesStutas"] == "Show")
                            echo "<td>".$rowservices["servicesStutas"].'<i class="fa-solid fa-eye"></i>'."</td>";
                            else 
                            echo "<td>".$rowservices["servicesStutas"].'<i class="fa-solid fa-eye-slash"></i>'."</td>";
