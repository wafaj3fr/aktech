              ...
              <table id="example7" class="table table-bordered table-striped">
                ...
                <?php
                        ...
                        // echo "<td>"."<a href =\"alluseroppor.php?id_alluserOpp=".$rowOppor['detiles']."\">".$rowOppor["detiles"]."</a>"."</td>";
                            ...
                            <?php
                            if($rowclients["clientsStutas"] == "show")
                            echo "<td>".$rowclients["clientsStutas"].'<i class="fa-solid fa-eye"></i>'."</td>";
                            else 
                            echo "<td>".$rowclients["clientsStutas"].'<i class="fa-solid fa-eye-slash"></i>'."</td>";
                            echo "<td>Sort No.<b>0".$rowclients["ClientSort"]."</b></td>";
