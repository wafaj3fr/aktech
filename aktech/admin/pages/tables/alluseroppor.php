 ...
 -->
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><?php echo $_GET['id_alluserOpp'];?></h3>
            </div>
...
// if(isset($_POST['addExpe'])){
  ...
  $resultOpp = mysqli_query($conn, $sql_Opp);
...
// echo "<td>"."<a href =\"editstatus.php?id_OppStutas=".$rowOppor['idOpportunities']."\">"."Open"."</a>"."</td>";
// echo "<td>"."<a href =\"editstatus.php?id_OppStutas=".$rowOppor['idOpportunities']."\">"."Close"."</a>"."</td>";
...
// }
    ...
    // echo "<td>"."<a href =\"deleteOpportunities.php?id_OppDel=".$rowOppor['idOpportunities']."\">"."DELETER"."</a>"."</td>";
