  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Website Testimonial</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Website Testimonial</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <table id="example3" class="table table-bordered table-striped">
                ...
                <?php
                        ...
                        // if(isset($_POST['addExpe'])){
                          ...
                          $sql_Opportunities = "SELECT * FROM testimonial";
                        ...
                        if ($resultOpportunities->num_rows > 0) {
                          ...
                          while($rowOppor = $resultOpportunities->fetch_assoc()) {
                            echo "<tr >";
                            echo "<td>".$rowOppor["Testimonialname"]."</td>";
                        ...
                        // echo "<td>"."<a href =\"alluseroppor.php?id_alluserOpp=".$rowOppor['detiles']."\">".$rowOppor["detiles"]."</a>"."</td>";
                            ...
                            echo "<td>".$rowOppor["Testimoniatestpostion"]."</td>";
                            echo "<td>".$rowOppor["Testimonialcontent"]."</td>";
                            echo "<td>"."<a href =\"../forms/editTestimonial.php?id_areaEdit=".$rowOppor['id']."\">".'EDIT<i class="fa-sharp fa-solid fa-pen-to-square"></i>'."</a>"."</td>";
                            echo "</tr>";
