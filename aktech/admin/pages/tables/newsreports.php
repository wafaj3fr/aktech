  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>All Website News</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Website News</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card">
            ...
            <div class="card-body">
              <table id="example3" class="table table-bordered table-striped">
                ...
                <tr>
                  <th>Name</th>
                  <th>Content Section 1 </th>
                  <th>Content Section 2 </th>
                ...
                <?php
                        ...
                        // if(isset($_POST['addExpe'])){
                          ...
                          $sql_Opportunities = "SELECT * FROM news";
                        ...
                        // echo "<td>"."<a href =\"alluseroppor.php?id_alluserOpp=".$rowOppor['detiles']."\">".$rowOppor["detiles"]."</a>"."</td>";
                            ...
                            echo "<td>".$rowOppor["newscontent1"]."</td>";
                            echo "<td>".$rowOppor["newscontent2"]."</td>";
                            echo "<td>"."<a href =\"../forms/editNews.php?id_areaEdit=".$rowOppor['id']."\">".'EDIT<i class="fa-sharp fa-solid fa-pen-to-square"></i>'."</a>"."</td>";
                            echo "</tr>";
