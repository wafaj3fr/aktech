...
if ($resultbacuser->num_rows > 0) {
  ...
  while($rowuser = $resultbacuser->fetch_assoc()) {
    ...
    // echo "<td>".$rowuser["userphone"]."</td>";
    // echo "<td>".$rowuser["userphone"]."</td>";
    echo "<td>"."<a href =\"UserReport.php?id_UserReport=".$rowuser['useremail']."\">"."Certificate"."</a>"."</td>";
    echo "<td>"."<a href =\"UserReport.php?id_UserReport=".$rowuser['useremail']."\">"."Experience"."</a>"."</td>";
    echo "<td>"."<a href =\"UserReport.php?id_UserReport=".$rowuser['useremail']."\">"."Interestareas"."</a>"."</td>";
...
//     echo "<tr>";
    ...
    //  echo "<td>"."<a href =\"../../editExperience.php?op_id=".$row3['idExperience']."\">".'<i class="bx bx-pencil"></i>'."</a>"."</td>";
    //  echo "<td>"."<a href =\"../../editExperience.php?op_id=".$row3['idExperience']."\">".'<i class="bx bxs-trash"></i>'."</a>"."</td>";
...
//         echo "<td>"."<a href =\"../../editExperience.php?op_id=".$row4['InterestAreasid']."\">".'<i class="bx bx-pencil"></i>'."</a>"."</td>";
//         echo "<td>"."<a href =\"../../editExperience.php?op_id=".$row4['InterestAreasid']."\">".'<i class="bx bxs-trash"></i>'."</a>"."</td>";  
//     echo "</tr>";
//       }
//   } else {
//     echo "0 results";
