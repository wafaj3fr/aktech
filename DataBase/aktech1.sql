...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2024 at 07:08 PM
...
CREATE TABLE `contactfrom` (
  ...
  `mesname` mediumtext NOT NULL,
  `mseemail` varchar(50) NOT NULL,
  `phone` varchar(50) NOT NULL,
  `messubject` varchar(100) NOT NULL,
  `mescontent` longtext NOT NULL,
...
(12, 'Greater Pioneer Operating\r\nCompany (GPOC)', 'Provision of General Engineering Services (GES)', 'Verify existing Electrical engineering documents via site verification and Mark-ups and produce As-built packages for GPOC.', 'South Sudan', '2023', 'Deliverables includes (Single line diagrams, layouts, Schematic drawings, Specifications, datasheets,\r\ncalculation reports, cable schedule and installation details drawings)', 'Provision of Electrical Engineering Deliverables for Unity FPF', '	\r\nassets/images/index/project/ppp1.png', '	 assets/images/index/project/ppp2.png', '', '0'),
(13, 'Greater Pioneer Operating\r\nCompany (GPOC)', 'Provision of General Engineering Services (GES)', 'Verify existing Electrical engineering documents via site verification and Mark-ups and produce As-built packages for GPOC.', 'South Sudan', '2023', 'Deliverables includes (Single line diagrams, layouts, Schematic drawings, Specifications, datasheets,\r\ncalculation reports, cable schedule and installation details drawings)', 'Provision of Electrical Engineering Deliverables for Unity FPF', '	\r\nassets/images/index/project/ppp1.png', '	 assets/images/index/project/ppp2.png', '', '0');
...
CREATE TABLE `services` (
  ...
  `bullet1` varchar(500) NOT NULL,
  `bullet2` varchar(500) NOT NULL,
  `bullet3` varchar(500) NOT NULL,
  `bullet4` varchar(500) NOT NULL,
  `bullet5` varchar(500) NOT NULL,
  `bullet6` varchar(500) NOT NULL,
  `bullet7` varchar(500) NOT NULL,
  `bullet8` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
