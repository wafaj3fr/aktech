...
(9, 'BOLD', 'We are no longer willing to remain the \"best-kept secret\" ofcustomer-focused trade and we are determined to amplify the globalawareness of our reputation as a major player within the exportindustry.', '', '', '', '', '', '', '', 0),
